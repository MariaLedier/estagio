...
export default function VeiculoDetalhePage() {
    ...
    function handlePlaca(e) { setPlaca(formatarPlaca(e.target.value)) }
    function handleRenavam(e) { setRenavam(formatarRenavam(e.target.value)) }
    function handleKm(e) { setKmatual(formatarKm(e.target.value)) }
    ...
    function abrirEdicao() {
        ...
        setMarca(veiculo.marca || "")       // ← agora tem valor
        ...
        if (veiculo.marca) carregarModelos(veiculo.marca)  // ← carrega modelos da marca
        setEditando(true)
    }
                    ...
                    <>
                        ...
                        <div style={styles.atalhos}>
                            ...
                            <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
                                <button
                                    onClick={() => router.push(`/dashboard/abastecimento/${id}`)}
                                    style={styles.atalho}
                                >
                                    ⛽ Abastecimentos
                                </button>
                                <button
                                    onClick={() => router.push(`/dashboard/manutencao/${id}`)}
                                    style={styles.atalho}
                                >
                                    🔧 Manutenções
                                </button>
                                <button
                                    onClick={() => router.push(`/dashboard/pneus/${id}`)}
                                    style={styles.atalho}
                                >
                                    🔄 Pneus
                                </button>
